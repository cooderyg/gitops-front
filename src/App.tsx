...
import {
  ResumeResourceApiFactory,
  Resume,
  Configuration as ResumeConfiguration,
} from "./react-applicant-common";
import {
  JobPostingResourceApiFactory,
  JobPosting,
  Configuration as JobPostingConfiguration,
} from "./react-jobposting-common";
...
function App() {
  ...
  useEffect(() => {
    ...
    const resumeApiConfig = new ResumeConfiguration({
      basePath: "https://applicant.cvcontrol.shop",
    }); // https://app.weplat.shop
    ...
    // job backend Data
    const jobPostingApiConfig = new JobPostingConfiguration({
      basePath: "https://jobposting.cvcontrol.shop",
    }); // https://job.weplat.shop
          ...
          <Stack spacing={2}>
            ...
            <ItemLeft>
              <Button variant="contained">
                Applicant App BackEnd Data - 이력서 정보
              </Button>
            </ItemLeft>
            ...
            <ItemLeft>
              <Button variant="contained">
                Jobposting App BackEnd Data - 채용공고 정보
              </Button>
            </ItemLeft>
